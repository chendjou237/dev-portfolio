...
function HeroSection() {
  return (
    <section className="flex relative flex-col justify-between items-center py-4 lg:py-12">
      <Image
        src="/hero.svg"
        alt="Hero"
        width={1572}
      ...
      <div className="grid grid-cols-1 gap-y-8 items-start lg:grid-cols-2 lg:gap-12">
        <div className="flex flex-col order-2 justify-center items-start p-2 pb-20 lg:order-1 md:pb-10 lg:pt-10">
          ...
          <div className="flex gap-3 items-center">
            ...
            <Link className="flex gap-1 items-center px-3 py-3 text-xs font-medium tracking-wider text-center text-white no-underline uppercase bg-gradient-to-r from-pink-500 to-violet-600 rounded-full transition-all duration-200 ease-out hover:gap-3 md:px-8 md:py-4 md:text-sm hover:text-white hover:no-underline md:font-semibold" role="button" target="_blank" href={personalData.resume}
            >
          ...
          <div className="overflow-hidden border-t-[2px] border-indigo-900 px-4 lg:px-8 py-4 lg:py-8">
            <code className="font-mono text-xs md:text-sm lg:text-base">
              ...
              <div>
                ...
                <span className="text-gray-400">{`'`}</span>
                <span className="text-amber-300">Chendjou Honore</span>
                <span className="text-gray-400">{`',`}</span>
              </div>
              ...
              <div><span className="mr-2 ml-8 text-gray-400 lg:ml-16">{`);`}</span></div>
